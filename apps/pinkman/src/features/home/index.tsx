...
const HomeScreen = ({ route, navigation }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ fontSize: 24, color: 'green' }}>MonkeyPox Master</Text>
      </View>
        ...
        {!loaderOpen && (
          ...
          >
            <View style={{ gap: 24, padding: 16, paddingBottom: 0 }}>
              <Text style={{ fontSize: 46, fontWeight: '700', color: 'green' }}>
                Welcome
              </Text>
              <Text style={{ fontSize: 16, lineHeight: 24 }}>
                ...
                computer-aided monkeypox identification from skin lesion images
                can be a beneficial measure
              </Text>
            </View>
