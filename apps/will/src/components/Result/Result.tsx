...
export default function Result(){
  ...
  return(
    ...
    <div style={{backgroundImage:"url(../../assets/AdobeStock_6.jpeg)" , backgroundSize:'120% 100%',backgroundRepeat:'no-repeat'}}>
      <div style={{ paddingTop:'10%'}}>
      <div className="result col-md-4" style={{border:'1px solid #00cc99',display:'flex',alignItems:'center',justifyContent:'center', margin:'auto' }}>
      <p>result is {result}</p>
      <br />
    </div>
    <div className="treatment col-md-6" style={{border:'1px solid #00cc99', display:'block', margin:'auto', padding:'30px', boxShadow:' 7px 7px #8881'}}>
      <h3>Treatment</h3>
